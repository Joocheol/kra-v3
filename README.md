...
- 평균 차이: **-0.00060654**
  - 날짜 cluster bootstrap 95%: **[-0.00097370, -0.00024464]**
- 가장 강한 삼복승+쌍승 기준선과의 공통표본 차이:
  **-0.00026665** (95% **[-0.00049398, -0.00003277]**, 2,312경주)
- 비교 기준이 ordinary Harville → dual-discounted → 쌍승+단승 →
  삼복승+쌍승으로 강해질수록 차이는 -0.00098517 → -0.00060654 →
  -0.00046119 → -0.00026665로 단조 감소
- 출전두수별 dual-discounted 비교는 10--11두에서만 구간 전체가 음수였고,
  7--9두와 12--14두 구간은 0을 포함해 효과가 모든 field-size에서 확정적이지 않음
...
각각 p=0.0311, p=0.0080으로 관측 capped 적중수를 유의하게 과대예측한다.
이는 favourite-longshot 편향과 회계 잔여질량 과대를 분리하지 못한다.
