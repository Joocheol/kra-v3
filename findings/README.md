...
- `snapshot_timing.md`: 2016--2019년 가까운 단일 스냅샷 가설 직접검사
- `masked_reconstruction.md`: 가상 상한 배분모형의 시간외 검증
- `sparse_multinomial_baseline.md`: 실제 상한 셀의 최소 대칭 기준선
- `dirichlet_multinomial.md`: 가상 상한 선택표본의 과산포 진단
